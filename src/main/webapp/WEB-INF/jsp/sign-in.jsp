    ...
    <div class="main__content">
        <div class="main__content__header">
            ...
            <div class="main__content__header--links">
                <div class="links">
                    <div class="button back"><a href="./sign-up">&lsaquo;</a></div>
                    <div class="button register"><a href="./sign-up">Регистрация</a></div>
                </div>
            </div>
        </div>
        <div class="main__content--register">
            <form action="/CarRentalService_war_exploded/registration/sign-up" >
                <div class="container">
                    <p>Заполните все поля для входа.</p>
                    <hr>

                    <label><b>Номер телефона</b></label>
                    <input id="phone-mask" type="text" placeholder="+{375} (__) ___-__-__" name="email"
                           autocomplete="username" required>

                    <label><b>Пароль</b></label>
                    <input type="password" placeholder="Введите пароль" name="psw" autocomplete="password" required>
                    <hr>
                    <html lang="en">
